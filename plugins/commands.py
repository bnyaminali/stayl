...
"""
    ...
    buttons = [
        [
            InlineKeyboardButton('👥 instagram', url=f"https://www.instagram.com/bnay_7aji/"),
            InlineKeyboardButton('Channel 📢', url=f"https://t.me/mad_tk")
            ],[
            InlineKeyboardButton('❤️ Credit', url=f"https://t.me/bny0min"),
            InlineKeyboardButton('snapchat 🤖', url=f"https://snapchat.com/add/bnyaminali"),
            InlineKeyboardButton('group  🤣', url=f"https://t.me/xakchat")
            ],[
            InlineKeyboardButton('⚜️ YOUTUBE ⚜️', url=f"https://www.youtube.com/channel/UCGUfn9gy7lSA74Jh2yajpEw")
        ]
    ]
    await m.reply_text(
        text=text,
...
async def style_buttons(c, m, cb=False):
    buttons = [[
        ...
        InlineKeyboardButton('دوواتر ➡️', callback_data="nxt")
    ]]
    if not cb:
